...
{
    [TestFixture]
    public class TestAdfsOidcAdapter
    {
        //---------------------------------------------------------------------
        // IssuerUrl.
        //---------------------------------------------------------------------
        ...
        [Test]
        public void WhenIssuerUrlLacksTrailingSlash_ThenSlashIsAppended()
        {
            var adapter = new AdfsOidcAdapter(
        ...
        [Test]
        public void WhenIssuerUrlHasTrailingSlash_ThenNoSlashIsAppended()
        {
            var adapter = new AdfsOidcAdapter(
                new Uri("https://example.com/adfs/"),
                "client-id",
